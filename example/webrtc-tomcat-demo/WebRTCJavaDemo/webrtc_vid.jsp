...
<html>
<head>
	<title>Aculab Cloud WebRTC Java demo</title>
	<link rel="icon" type="image/gif" href="images/favicon.gif" />
	<script src="https://code.jquery.com/jquery-1.10.2.js" type="text/javascript"></script>
	<script type='application/javascript' src='https://webrtc-0-2-0.aculabcloud.net/js/3/AculabCloudCaller.js'></script>
	<script type='application/javascript' src='js/webrtc_demo.js'></script>
	<script type='application/javascript' src='js/app-ajax.js'></script>
</head>
<body> 
    <h2>Aculab Cloud WebRTC Java demo</h2>
	<table>
		<tr>
			<td>Step 1: Enter a Client ID name and click Create to register with WebRTC</td>
			<td>Step 2: Click "Generate token" then click "Enable" to enable incoming calls</td>
		</tr>
		<tr>
			<td style="padding:10px">
				<table><tr><td>
					...
					<input id="con_state" size=60 value="Not conntected" disabled=true>
				</td></tr></table>
			</td>
			<td style="padding:10px">
				<table>
